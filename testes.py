...
class Window(QtWidgets.QWidget):
    def __init__(self):
        ...
        self.content.setObjectName("conteudo")
        content_layout = QtWidgets.QVBoxLayout(self.content)

        label_conteudo = QtWidgets.QLabel("Bem vindo ao Plotter!")
        label_conteudo.setAlignment(QtCore.Qt.AlignCenter)
        content_layout.addWidget(label_conteudo)
